...
# a la división territorial establecida por la Municipalidad, y por otro lado 
# tomaremos la división de la ciudad en fracciones censales, de acuerdo a las 
# divisiones consideradas en el Censo Nacional de Población, Hogares y Viviendas 
# 2001 (ya que para 2010 dicha información no se encuentra disponible). Estas 
# divisiones pueden visualizarse en el mapa de Rosario [Infomapa Rosario](http
# ://infomapa.rosario.gov.ar/).

# En base a estas divisiones definimos los siguientes vectores numéricos, en donde 
# cada uno de ellos se corresponde con un distrito (y por esto se les asigna su 
# nombre), y cada elemento (número) de un vector se corresponde con el número de 
# fracción:
...
# Ahora vamos a definir algo que en programación de llama "lista". Una lista es 
# muy parecida a un vector, con la diferencia que un elemento de una lista puede 
# ser cualquier cosa, ya sea un número, palabra, vector, o bien una matriz, etc.
...
# Esta lista tiene una longitud igual a 6, considerándose como elemento a un 
# vector:
...
# 2. Comienza un proceso iterativo a través de los elementos de la lista, es 
# decir, a través de los distritos.
...
# 6. Concatena verticalmente paso 5 a trevés de los distintos distritos.
